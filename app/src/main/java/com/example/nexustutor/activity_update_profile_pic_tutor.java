...
public class activity_update_profile_pic_tutor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_profile_pic_tutor);
        ...
        updatePicButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                CropImage.activity().setAspectRatio(1,1).start(activity_update_profile_pic_tutor.this);
            }
        });
